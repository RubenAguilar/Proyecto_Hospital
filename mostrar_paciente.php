...
<div>
         ...
         <main>
            <div class="container">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">Ruben Alonzo Aguilar Ramirez</h3>
                                <h6>Correo:</h6>
                                <p class="card-text">Correo_de_ejemplo@hotmail.com</p>
                               <h6>Telefóno:</h6>
                                <p class="card-text">9811066298</p>
                               
                                    <div class="btn_modal_paciente">
                                                        <!-- Button trigger modal Editar -->
                                            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#Modal_Editar">
                                            Editar
                                            </button>
                                    

                                                        <!-- Button trigger modal Eliminar-->
                                            <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#Modal_Eliminar">
                                            Eliminar
                                            </button>
                                      </div>       
