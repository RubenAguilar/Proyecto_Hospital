            ...
            <div class="container">
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Especialidad" aria-describedby="EspecialidadHelp" >
                            
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Numero Consultorio</label>
                            <input type="number" class="form-control" id="Num_consultorio" placeholder="000" >
