...
<div class="card">
  ...
  <div class="card-body">
  <form class="container"action="../controladores/Alta.php" method="POST">
  ...
  <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="usuario" id="usuario" pattern="[A-Za-z0-9-]{1,1000000}" placeholder="Ingresa tu usuario">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">contraseña</label>
      <input type="text" class="form-control" id="contrasenap" name="contrasenap" pattern="[A-Za-z0-9-]{1,1000000}" placeholder="Ingresa tu contraseña">
    </div>
  </div>
  <div class="form-group">
    <label for="inputAddress">Nombre</label>
    <input type="text" class="form-control" id="Nombre" pattern="[A-Za-z]+" name="Nombre" placeholder="Ingresa tu nombre">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Numero Telefonico</label>
    <input type="number" class="form-control " id="Telefonop" min="0" name="Telefonop" placeholder="ejemplo: 981-139-7736">
  </div>
  <div class="row">
    <div class="col-10">
