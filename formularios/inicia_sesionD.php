...
<div class="card">
  ...
  <?php
    ...
    <input type="text" class="form-control" id="user" name="user" pattern="[A-Za-z0-9-]{1,1000000}" placeholder="Ingresa tu usuario">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Contraseña</label>
    <input type="password" class="form-control" id="contrasenad" pattern="[A-Za-z0-9-]{1,1000000}" name="contrasenad" placeholder="Ingresa tu contraseña">
  </div>
